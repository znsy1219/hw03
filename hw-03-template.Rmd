...
a) Apply the workflow you defined earlier to the `gss16_advfront` dataset and display the resulting tibble containing the fitted model parameters. 
...
- Apply both of your models to the `gss16_advfront` using the two different workflows that you have defined. Then use the fitted models to predict the test data, plot the ROC curves for the predictions for both models, and calculate the areas under the ROC curves.
